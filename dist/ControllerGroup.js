...
var ControllerGroup = /** @class */ (function () {
    function ControllerGroup(bridge) {
        this.controllers = [];
        this.storage = new ControllerStorage(bridge);
    }
    ControllerGroup.prototype.add = function (_controller) {
        var _this = this;
        _controller.forEach(function (controller) {
            controller.state = [];
            controller.mount = false;
            controller.callHistroy = [];
            controller.connect = function (_state, _handler) {
                controller.state.push([_state, _handler]);
            };
            controller.pushToCallHistory = function (_caller) {
    ...
    ControllerGroup.prototype.unsubscribe = function (_controller_name) {
        this.controllers
            .filter(function (_controller) {
    ...
    ControllerGroup.prototype.run = function (_method, _input, _states) {
        var _this = this;
    ...
    ControllerGroup.prototype.connect = function (_controller_name, _handler) {
    ...
    ControllerGroup.prototype.setState = function (name, new_state) {
        var _this = this;
        this.controllers.filter(function (controller) {
            return controller.name === name;
        }).forEach(function (controller) {
            controller.onChange(controller, _this, new_state);
        });
    };
    ControllerGroup.prototype.getDefault = function (_controller_name) {
        var _default;
        this.controllers.filter(function (controller) {
            return controller.name === _controller_name;
        }).forEach(function (controller) {
    ...
    ControllerGroup.prototype.getController = function (_controller_name) {
        var _controller;
        this.controllers.filter(function (controller) {
            return controller.name === _controller_name;
        }).forEach(function (controller) {
    ...
    ControllerGroup.prototype.getPlatform = function () {
        this.storage.platform;
    };
    ControllerGroup.prototype.mount = function (_controller_name) {
        this.controllers.filter(function (controller) {
            return controller.name === _controller_name;
        }).forEach(function (controller) {
    ...
    ControllerGroup.prototype.unmount = function (_controller_name) {
        this.controllers.filter(function (controller) {
            return controller.name === _controller_name;
        }).forEach(function (controller) {
            controller.mount = false;
    ...
    ControllerGroup.prototype.all = function () {
